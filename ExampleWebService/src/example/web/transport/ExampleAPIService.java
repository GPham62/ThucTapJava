...
public class ExampleAPIService {
    ...
    private static final Logger _logger = LoggerFactory.getLogger(ExampleAPIService.class);
    private static ExampleAPIService _instance;
    private static String _host = "";
    private static int _port = 0;

    static {
        _host = Config.getParamString("ExampleAPI", "host", "");
        _port = Config.getParamInt("ExampleAPI", "port", 3005);

    }

    public static ExampleAPIService getInstance() {
        if (_instance == null) {
            _instance = new ExampleAPIService();
        }
